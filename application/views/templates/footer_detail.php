...
<footer class="footer">
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2018 <a class="font-weight-bold ml-1" target="_blank"></a>
            </div>
          </div>
        </div>
      </footer>
  ...
  <!-- Argon JS -->
  <script src="<?= base_url('assets/assets/js/argon.js?v=1.0.0') ?>"></script>
  <!-- Datepicker -->
  <script src="<?= base_url('assets/assets/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') ?>"></script>
  <!-- SWEETALERT -->
  <script src="<?= base_url('assets/assets/vendor/sweetalert/sweetalert2.all.min.js') ?>"></script>
  <!-- Custom JS -->
