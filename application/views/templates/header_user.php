...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url('assets/user');?>/img/apple-icon.png">
  ...
  <link href="<?= base_url('assets/user');?>/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="<?= base_url('assets/user');?>/css/soft-ui-dashboard.css?v=1.0.5" rel="stylesheet" />
</head>